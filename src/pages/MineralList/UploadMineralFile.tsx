...
const UploadMineralFile = () => {
  ...
  return (
    <>
      {data?.length ? "Have some data" :<form
        {...getRootProps()}
        ...
        <div className="dz-message flex flex-col items-center m-0!">
          ...
          <div className="mb-[22px] flex justify-center">
            <div className="flex h-[68px] w-[68px]  items-center justify-center rounded-full bg-gray-200 text-gray-700 dark:bg-gray-800 dark:text-gray-400">
             {isLoading ? <i className="pi pi-spinner !animate-spin "></i>: <svg
          ...
          <div className="flex flex-row items-center justify-center gap-5">
            ...
            <Tooltip position="right" target={".data-format"}>
              <span className="text-[13px]">
                ...
                headers: name, emails, numbers, address, location, description.
                Emails, numbers, and address should be comma-separated in a
                single cell. Each row must represent one mineral resource with
                all fields filled. Example: emails →
